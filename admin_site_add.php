...
<?php
    ...
    if (isset($_REQUEST['btn_site_insert'])) {
        ...
        if (empty($sitename)) {
            ...
            try {
                if (!isset($errorMsg)) {
                    $insert_stmt = $db->prepare("INSERT INTO site(site_name, site_status) VALUES (:fname, :sta)");
                    $insert_stmt->bindParam(':fname', $sitename);
                    $insert_stmt->bindParam(':sta', $$insert_stat);
                    $$insert_stat = "b";
                    ...
                    <div class="card-header">
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="col-md-12 mt-4">
                                            <span> เพิ่มไซต์งาน</span>
                                            <textarea class="form-control mt-5" name="txt_sitename"  id="comment" placeholder="กรุณากรอกชื่อไซต์งาน" max="300" ></textarea>              
                                        </div>
                                        </div>
