<?php
  ...
  //  $row = $select_stmt->fetch(PDO::FETCH_ASSOC);
	...
	if($act=='add' && !empty($p_id))
	{
		...
		{
            $num = $_SESSION['cart'][$p_id];
            $num = $num + 1;
			$_SESSION['cart'][$p_id]=$num;
		}
		else
		{
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h3>ยืมอุปกรณ์</h3>
                            <span class="ml-1">ยืมอุปกรณ์ สำหรับใช้ในไซต์งาน</span>
                        </div>
                    </div>
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php  
                                                            if ($row["type_id"] == '1'){
                                                            ?>
                                                            <span class="badge badge-dark">วัสดุ</span>
                                                        ...
                                                        <td ><?php  
                                                            if ($row["mat_amount"] > 0){
                                                            ?>
                                                            <a href="user_stockout.php?p_id=<?php echo $row["id"];?>&act=add" class="btn btn-outline-primary">เบิก&nbsp;</a>
                                ...
                                <form method="post" action="?act=update&p_id=0" >
                                    <table id="example2" class="display table" style="width:100%">
                                        ...
                                        <?php 
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="user_stockout.php?p_id=<?php echo $p_id ;?>&act=remove" class="btn btn-outline-danger">ลบ</a></td>
                                       ...
                                       <?php  
                                        ...
                                        <input type="submit" name="button" class="btn btn-success" id="button" value="ตรวจสอบรายการอุปกรณ์" />                       
                                    ...
                                    <a href="db_sto_add2.php" class="btn btn-success col-md-12 mt-3 ">แจ้งการยืมอุปกรณ์</a>
                                    
                                    <?php } else { ?>
                                        <font color="red" align='center' > *กรุณากดปุ่ม " ตรวจสอบรายการอุปกรณ์ "  ก่อนการทำรายการถัดไป!! </font>
                                        <?php } ?>
                                    </form>
                                </div>
                                <br>                                                        
