            ...
            <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h3>คืนอุปกรณ์</h3>
                            <span class="ml-1">การคืนอุปกรณ์เข้าคลัง</span>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">ตารางรายการอุปกรณ์ที่ถูกยืมออกไป</h4>
                                ...
                                <table id="example2" class="display table" style="width:100%">
                                        ...
                                        <thead class="thead-primary">
                                            <tr>
                                                ...
                                                <th class="col-1">วันคืนอุปกรณ์</th>
                                                <th class="col-1">รายการ</th>
                                                <th class="col-1">คืนอุปกรณ์</th>
                                        ...
                                        <?php 
                                            ...
                                            ?>
                                                <?php  
                                                        if ($row["od_ty"] == '1'){
                                                            if ($row["od_status"] == '3' &&  $row["od_name"] == $name_f){
                                                            ?>
                                                <tr>


                                                    <td><span class="badge badge-info">คืนอุปกรณ์</span>   </td> 
                                                    ...
                                                    <td><a href="approv2.php?apr_id=<?php echo $row["od_id"]; ?>" class="btn btn-outline-success">คืนอุปกรณ์</a>
