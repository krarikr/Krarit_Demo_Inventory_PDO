            ...
            <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h3>จัดการข้อมูลโฟร์แมน</h3>
                            <font color=#0000 size=3>จัดการข้อมูลโฟร์แมนที่ทำงานอยู่ในบริษัท</font>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <a href="admin_pro_add.php" class="btn btn-success mb-3" >เพิ่มรายชื่อโฟร์แมน</a>
                    </div>
                </div>
                <!-- row -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <table id="example2" class="display table" style="width:100%">
                                        ...
                                        <tbody>
                                        <?php 
                                             $select_material = $db->prepare("SELECT * FROM  user_ptk");
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php  
                                                            if ($row["user_level"] == 'a'){
                                                            ?>
                                                            <span class="badge badge-danger">เลิกจ้าง</span>

                                                            <?php }else{?>

                                                                <span class="badge badge-info">ทำงาน</span>

                                                            <?php } ?></td>   
                                                    <td><a href="admin_pro_edit.php?user_update_id=<?php echo $row["id"]; ?>" class="btn btn-outline-warning">แก้ไข</a></td>
                                                    <td><a href="db_admin_pro_end.php?enduser_id=<?php echo $row["id"]; ?>" class="btn btn-outline-danger">เลิกจ้าง</a></td>      
                                                    <td><a href="db_admin_pro_start.php?startuser_id=<?php echo $row["id"]; ?>" class="btn btn-outline-primary">จ้าง</a></td>                                      
                                                </tr>
