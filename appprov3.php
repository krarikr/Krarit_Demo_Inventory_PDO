<?php 
       ...
       if (isset($_REQUEST['apr_id'])) {
          ...
          if($site_end->execute()){
            ...
            $insert_odmt= $db->prepare("INSERT INTO his_hti (hti_id, hti_od_id, hti_od_name, hti_od_date, hti_od_site ) VALUES (null, :ot1, :ot2, :ot3, :ot4)");
          ...
          // header('Location:admin_list_sti.php');
