            ...
            <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h3>ตารางยืม-คืนอุปกรณ์</h3>
                            <font color=#0000 size=3>ตารางรายการที่ถูกส่งเข้ามาอนุมัติ</font>
                        </div>
                    </div>
                                ...
                                <table id="example2" class="display table" style="width:100%">
                                        ...
                                        <?php 
                                            ...
                                            ?>
                                                <?php  
                                                            if ($row["od_ty"] == '1'){
                                                            if ($row["od_status"] == '1'|| $row["od_status"] == '4'){
                                                            ?>
                                                <tr>
                                                ...
                                                <?php  
                                                            if ($row["od_status"] == '1'){
                                                            ?>
                                                            <span class="badge badge-info">ยืมอุปกรณ์</span>
                                                            
                                                            <?php }else if ($row["od_status"] == '4') { 
                                                                ?>

                                                            <span class="badge badge-success">คืนอุปกรณ์</span>
                                                    ...
                                                    <td><a href="list_order_admin.php?od_id=<?php echo $row["od_id"]; ?>" class="btn btn-outline-warning">รายการ</a></td>
                                                    <td><?php  
                                                            if ($row["od_status"] == '1'){
                                                            ?>
                                                            <a href="appprov.php?apr_id=<?php echo $row["od_id"]; ?>" class="btn btn-outline-success">อนุมัติ</a>
                                                            
                                                            <?php }else if ($row["od_status"] == '4') { 
                                                                ?>

                                                            <a href="appprov3.php?apr_id=<?php echo $row["od_id"]; ?>" class="btn btn-outline-success">อนุมัติ</a>
                                                    ...
                                                    <?php  
                                                            if ($row["od_status"] == '1'){
                                                            ?>
                                                            <a href="dissapprov.php?apr_id=<?php echo $row["od_id"]; ?>" class="btn btn-outline-danger">ไม่อนุมัติ</a>
                                                            
                                                            <?php }else if ($row["od_status"] == '4') { 
                                                                ?>

                                                            <a href="dissapprov2.php?apr_id=<?php echo $row["od_id"]; ?>" class="btn btn-outline-danger">ไม่อนุมัติ</a>
