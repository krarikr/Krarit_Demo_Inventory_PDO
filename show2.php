<?php
    ...
    if (isset($_REQUEST['btn_po_insert'])) {
        ...
        $image_file = $_FILES['txt_file']['name'];
            ...
            $path = "./ptk2/images" . $image_file; // set upload folder path
         ...
         if (empty($po_adate)) {
            ...
            if (!file_exists($path)) {  // check file ตรงที่หรือป่าว
                ...
                if ($size < 5000000) { // check file size  ขนาด 5MB
                    ...
                    move_uploaded_file($temp, '/ptk2/images'.$image_file); // move upload file temperory directory to your upload folder
                } else {
