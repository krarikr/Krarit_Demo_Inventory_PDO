            ...
            <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            ...
                            <span class="ml-1">ตารางรายการซื้ออุปกรณ์</span>
                        </div>
                    </div>
                                        ...
                                        <?php 
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <a href="#" class="btn btn-warning">สั่งซื้อเร่งด่วน</a></td>
                                                    <td><?php echo $row["po_user"]; ?></td>
                                                    <td><?php echo $row["po_site"]; ?></td>
                                                    <td><?php echo $row["po_date"]; ?></td>
                                                    <td><a href="order_po_images/<?php echo $row['po_image']; ?>" data-lightbox="image-1" data-title="My caption" class="btn btn-outline-warning">รายการสั่งซื้อเร่งด่วน</a></td>
                                                    <td><a href="db_admin_po_accep.php?accpo_id=<?php echo $row["id"]; ?>" class="btn btn-outline-primary">รับทราบแล้ว</a></td>
