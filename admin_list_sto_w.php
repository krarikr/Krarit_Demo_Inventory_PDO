            ...
            <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>ข้อมูลการเบิกถอนวัสดุ</h4>
                            <font color=#0000 size=3>ตารางรายการเบิกถอนวัสดุ</font>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <table id="example2" class="display table" style="width:100%">
                                        ...
                                        <tbody>
                                        <?php 
                                             $select_material = $db->prepare("SELECT * FROM  his_sto_w");
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                <td><?php echo $row["hto_id"]; ?></td>
                                                <td> 
                                                            <span class="badge btn-outline-dark">เสร็จสิ้น</span>
                                                        </td>
                                                    <td><?php echo $row["hto_od_name"]; ?></td>
                                                    <td><?php echo $row["hto_od_date"]; ?></td>
                                                    <td><?php echo $row["hto_od_site"]; ?></td>
                                                    <td><a href="list_order_admin.php?od_id=<?php echo $row["hto_od_id"]; ?>" class="btn btn-outline-warning">รายการ</a></td>
