            ...
            <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            ...
                            <font color=#0000 size=3>ข้อมูลรายการวัสดุ/อุปกรณ์ ในปัจจุบัน</font>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <a href="admin_mat_add.php" class="btn btn-success mb-3" >เพิ่มรายการวัสดุ/อุปกรณ์</a>            
                    </div>
                </div>
                <!-- row -->
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php  
                                                            if ($row["mat_amount"] > 0){
                                                            ?>
                                                            <span class="badge badge-info">มีของ</span>
