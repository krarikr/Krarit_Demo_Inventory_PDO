            ...
            <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>ข้อมูลการคืน</h4>
                            <font color=#0000 size=3>ตารางรายการอุปกรณ์ที่ถูกยืมออกไป</font>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <table id="example2" class="display table" style="width:100%">
                                        ...
                                        <tbody>
                                        <?php 
                                             $select_material = $db->prepare("SELECT * FROM  his_hti");
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                <td><?php echo $row["hti_id"]; ?></td>
                                                <td> 
                                                            <span class="badge btn-outline-dark">เสร็จสิ้น</span>
                                                        </td>
                                                    <td><?php echo $row["hti_od_name"]; ?></td>
                                                    <td><?php echo $row["hti_od_date"]; ?></td>
                                                    <td><?php echo $row["hti_od_site"]; ?></td>
                                                    <td><a href="list_order_admin.php?od_id=<?php echo $row["hti_od_id"]; ?>" class="btn btn-outline-warning">รายการ</a></td>
