                                        ...
                                        <?php 
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                 ...
                                                 <td> <span class="badge badge-success">เบิกวัสดุ</span>
                                                        </td>    
                                                    ...
                                                    <td>
                                                            <a href="appprov_w.php?apr_id=<?php echo $row["od_id"]; ?>" class="btn btn-outline-success">อนุมัติ</a>
                                                
                                                </td>
                                                    <td><a href="dissapprov.php?apr_id=<?php echo $row["od_id"]; ?>" class="btn btn-outline-danger">ไม่อนุมัติ</a></td>                               
                                                </tr>
